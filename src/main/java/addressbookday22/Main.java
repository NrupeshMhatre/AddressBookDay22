...
public class Main {
	private static List<AdressBook> addressBooks = new LinkedList<AdressBook>();
	...
	private static void addressMenu(AdressBook addressBook) {
